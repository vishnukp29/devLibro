          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              ...
              <div className="w-full lg:w-3/5 px-4 mb-16 lg:mb-0 order-first lg:order-last">
                <span className="flex mb-10 mx-auto items-center justify-center h-20 w-20 bg-black rounded-lg">
                  <svg
                    width="37"
                    height="37"
                    viewBox="0 0 37 37"
                ...
                <h2 className="mb-10 text-center text-6xl lg:text-7xl text-slate-700 font-bold font-heading">
