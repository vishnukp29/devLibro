                            ...
                            <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                              <h1 className="text-2xl font-bold text-gray-900 ">
                                ...
                                {profile?.isAccountVerified ? (
                                  <span className="inline-flex ml-0 items-center px-3 py-0.5  rounded-lg text-sm font-medium bg-green-600 text-gray-300">
                                    Account Verified
                                  </span>
                                ) : (
                          ...
                          profile?.posts.map((post) => (
                            <div className="flex flex-wrap  -mx-3 mt-3  lg:mb-6">
                              ...
                              <div className="w-full lg:w-3/4 px-3">
                                ...
                                >
                                  <h3 className="mb-1 text-2xl text-slate-700 font-bold font-heading">
                                    {post?.title}
                                  </h3>
                                </Link>
