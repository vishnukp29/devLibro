          ...
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-slate-700">
                  Create an Account and Start Pending Down Your Ideas
                </h2>
              </div>
            </div>
            <div className="w-full lg:w-1/2 px-4">
              <div className="px-6 lg:px-20 py-12 lg:py-24 bg-white rounded-xl border border-gray-500 drop-shadow-lg">
